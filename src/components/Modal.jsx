...
const Modal = ({ children, isOpen, onClose, title }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm">
      ...
      <div className="flex items-center justify-between px-8 py-4 bordeer-b border-gray-100">
        <h3 className="text-xl font-semibold text-gray-800">{title}</h3>
        <button onClick={onClose} className="p-1 rounded-full hover:bg-gray-200 transition-colors duration-200 text-gray-500 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-300">
