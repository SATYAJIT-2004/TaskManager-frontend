...
const SelectedUser = ({ selectedUser, setSelectedUser }) => {
    ...
    <div className="space-y-4 mt-2">
      {selectedUserAvatars.length === 0 && (
        <button
          ...
          className="flex items-center gap-4 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md transition-colors duration-200 shadow-md"
          type="button"
        >
          ...
          {allUsers?.map((user) => (
            ...
            >
              ...
              <input
                ...
                className="w-4 h-4 tetx-primary bg-gray-100 border-gray-300 rounded-sm outline-none"
              />
            </div>
          ))}
        </div>
